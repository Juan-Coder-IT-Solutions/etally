        ...
        $.post("ajax/get_event_participants.php",{
            ...
            for (let participantIndex = 0; participantIndex < res.data.length; participantIndex++) {
                ...
                tbody_tr += `<tr>
                    ...
                    <td><img class="img-account-profile rounded-circle" src="assets/img/profiles/${participantElem.participants.participant_img}" alt="Image" style="width: 100px;height: 100px;object-fit:cover;"></td>
                </tr>`;
            }
