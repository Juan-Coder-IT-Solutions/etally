...
CREATE DATABASE IF NOT EXISTS `etally_db` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
USE `etally_db`;
...
INSERT INTO `tbl_events` (`event_id`, `event_category_id`, `event_name`, `event_description`, `event_mechanics`, `event_venue`, `event_start`, `event_end`, `event_status`, `participant_needed`, `judge_needed`, `protest_hrs`, `encoded_by`, `date_added`, `date_modified`) VALUES
	(1, 1, 'Swimminh', 'Singing Contest ', '7a56tbNW7.pdf', ' ', '2024-01-19 14:59:00', '2024-01-19 10:00:00', 'P', 5, 4, 3.00, 0, '2023-10-28 14:18:34', '2024-01-19 15:00:29'),
	(2, 2, 'Badminton', 'Male Category', 'jlW0rT7Cp.pdf', 'University Gym', '2023-10-28 02:57:00', '0000-00-00 00:00:00', 'P', 10, 3, 0.00, 0, '2023-10-28 15:52:37', '2023-11-29 14:02:56'),
	(3, 1, 'hhhh', '  ', '8roZkVRk0.pdf', ' ', '2024-12-31 12:59:00', '0000-00-00 00:00:00', 'S', 4, 3, 4.00, 0, '2024-01-19 15:01:42', '2024-01-19 15:01:42');
...
-- Dumping data for table etally_db.tbl_event_judges: ~4 rows (approximately)
...
-- Dumping data for table etally_db.tbl_event_participants: ~9 rows (approximately)
INSERT INTO `tbl_event_participants` (`event_participant_id`, `event_id`, `participant_id`, `status`, `total_ranks`, `rank`, `date_added`, `date_modified`) VALUES
	...
	(3, 1, 6, 1, 3.00, 1.00, '2023-10-28 15:42:32', '2024-01-19 14:46:32'),
	(4, 2, 1, 1, 0.00, 0.00, '2023-10-28 15:52:52', '2023-10-28 15:52:52'),
	(5, 2, 4, 1, 0.00, 0.00, '2023-10-28 15:52:52', '2023-10-28 15:52:52'),
	(6, 1, 8, 1, 3.00, 2.00, '2023-11-06 15:14:46', '2024-01-19 14:46:32'),
...
-- Dumping data for table etally_db.tbl_protests: ~4 rows (approximately)
INSERT INTO `tbl_protests` (`protest_id`, `user_token`, `event_id`, `protest`, `date_added`, `date_modified`) VALUES
	(1, 'cmD2m', 4, 'gfhfg', '2023-10-26 15:48:20', '2024-01-19 03:16:56'),
	(2, 'zLMra', 4, 'fgdgd', '2023-10-26 15:48:44', '2024-01-19 03:16:47'),
	(3, 'sHIlF', 4, 'dfdgdg', '2023-10-26 15:48:51', '2024-01-19 03:16:52'),
	(4, 'xgu0q', 1, 'vhgv', '2024-01-19 11:14:24', '2024-01-19 11:14:24');
...
-- Dumping data for table etally_db.tbl_users: ~4 rows (approximately)
